...
| 3.0    | 25/11/2022 | Alterações no perfil de usuários | Luciano Freitas | Marcus Martins              |
| 3.1    | 27/11/2022 | Correções no artefato            | Luciano Freitas | Marcus Martins              |
| 3.2    | 01/12/2022 | Alterações nos textos com referências a outras seções            | Lucas Felipe | Luiza  Esteves          |
