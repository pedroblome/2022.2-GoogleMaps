...
| 25/11/2022   | 3.0 | Alterações no perfil de usuários | Luciano Freitas | Marcus Martins              |
| 27/11/2022  | 3.1 | Correções no artefato            | Luciano Freitas | Marcus Martins              |
| 01/12/2022   | 3.2 | Correções do Histórico de versão            | Lucas Felipe | Luiza Esteves              |
